...
public class FastPanelScript : MonoBehaviour
{
    ...
    public void UpdateToolsImages()
    {
        ...
        foreach (var type in InventoryManager.instance.toolsInventory.Keys)
        {
            ...
            if (tool.toolUIType == ToolUIType.Seed)
            {
                Backpack.SetBuffed( InventoryManager.instance.IsToolWorking(type));
            }
