...
public class EndMonthPanel : MonoBehaviour
{
	...
	public void ShowEndMonthPanel(Queue<CropsType> cropsQueue, int allCrops)
	{
		...
		MonthCropsCollectedText.text = "За этот месяц вы вырастили " + cropsAmount.ToString() + " овощей";
        AllCropsCollectedText.text = "Всего  " + allCrops.ToString() + " овощей";
	...
	{
		Queue<CropsType> tmpQueue = new Queue<CropsType>(cropsQueue);
