...
public class MainMenuButtons : MonoBehaviourSoundStarter
{
    ...
    public IEnumerator CropRain()
    {
        ...
        while (true)
        {
            ...
            a.gameObject.GetComponent<Rigidbody2D>().AddForce(new Vector2(Random.Range(-0.3f, 0.3f), -1) * impulseMultiplier, ForceMode2D.Impulse);
    ...
    public void EndCropRain()
    {
        ...
        {
            Destroy(VegsHolder.GetChild(i).gameObject, 8);
        }
    }
