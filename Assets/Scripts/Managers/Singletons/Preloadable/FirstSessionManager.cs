	...
	public class FirstSessionManager {
		...
		private void ShowBackpackSpotlight() {
			...
			UIHud.Instance.SpotlightWithText.ShowSpotlightOnButton(UIHud.Instance.Backpack.OpenButton,
				FtueConfig.BackpackHint, delegate
				{
		...
		private void ShowSeedsSelectSpotlight() {
			...
			UIHud.Instance.SpotlightWithText.ShowSpotlightOnButton(UIHud.Instance.Backpack.TomatoButton,
				FtueConfig.SeedSelectHint, StepEnded);
		}
		...
		private async UniTask ShowHoeSpotlight() {
			...
			UIHud.Instance.FastPanelScript.toolButtons[0].gameObject.SetActive(true);
			UIHud.Instance.SpotlightWithText.ShowSpotlightOnButton(UIHud.Instance.FastPanelScript.toolButtons[0],
				FtueConfig.HoeHint,
				StepEnded);
			await UniTask.WaitWhile(() => _isWaitingForStepEnd);
		...
		private void ShowWaterSpotlight() {
			...
			UIHud.Instance.FastPanelScript.toolButtons[1].gameObject.SetActive(true);
			UIHud.Instance.FastPanelScript.toolButtons[1].interactable = true;
			UIHud.Instance.SpotlightWithText.ShowSpotlightOnButton(UIHud.Instance.FastPanelScript.toolButtons[1],
				FtueConfig.WaterHint,
				StepEnded);
		}
		...
		private async UniTask ShowScalesSpotlight() {
			...
			UIHud.Instance.SpotlightWithText.ShowSpotlightOnButton(UIHud.Instance.ShopsPanel.ScalesButton,
				FtueConfig.ScalesHint, StepEnded,
				true);
			await UniTask.WaitWhile(() => _isWaitingForStepEnd);
		}
		...
		private async UniTask ShowSeedShopSpotlight() {
			...
			UIHud.Instance.SpotlightWithText.ShowSpotlightOnButton(UIHud.Instance.ShopsPanel.SeedShopButton,
				FtueConfig.SeedShopHint, StepEnded,
				true);
			await UniTask.WaitWhile(() => _isWaitingForStepEnd);
		...
		private async UniTask ShowGetNextLevelSpotlight() {
			...
			UIHud.Instance.SpotlightWithText.ShowSpotlightOnButton(buttonObj.GetComponent<Button>(),
				FtueConfig.ProfileHint, StepEnded, true);
			await UniTask.WaitWhile(() => _isWaitingForStepEnd);
		}
