...
public class SeedShopScript : MonoBehaviour
{
	...
	GameObject[] SeedButtons;
	Dictionary<CropsType, GameObject> buttonsD;
    ...
    void GenerateButtons()
    {
        ...
        for (int i = 0; i < SeedButtons.Length; i++)
        {
            ...
            seedOffer.BuyButton.onClick.AddListener(() => InventoryManager.instance.BuySeed(crop.type, crop.cost, crop.buyAmount));
	...
	public void SetAmbarCrop(CropsType type)
    {
		...
		ambarBuyButton.onClick.AddListener(() => InventoryManager.instance.BuySeed(crop.type, crop.cost, crop.buyAmount));
