    ...
    public class AnimatedTileEditor : Editor {
        ...
        private void OnDrawElement(Rect rect, int index, bool isActive, bool isFocused) {
            if (tile.m_AnimatedSprites != null && index < tile.m_AnimatedSprites.Length) {
                string spriteName = tile.m_AnimatedSprites[index] != null ? tile.m_AnimatedSprites[index].name : "Null";
        ...
        private void OnRemoveElement(ReorderableList list) {
            if (tile.m_AnimatedSprites != null && tile.m_AnimatedSprites.Length > 0 &&
                ...
                List<Sprite> sprites = tile.m_AnimatedSprites.ToList();
        ...
        private void DisplayClipboardText(GUIContent clipboardText, Rect position) {
            ...
            Rect rect = new(position.center.x - infoSize.x * .5f
        ...
        public override void OnInspectorGUI() {
            ...
            if (reorderableList != null) {
                int tileCount = tile.m_AnimatedSprites != null ? tile.m_AnimatedSprites.Length : 0;
