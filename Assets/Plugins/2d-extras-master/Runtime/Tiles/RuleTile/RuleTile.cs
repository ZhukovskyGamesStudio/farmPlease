...
namespace UnityEngine {
    ...
    public class RuleTile : TileBase {
        ...
        /// </summary>
        [HideInInspector]
        public List<TilingRule> m_TilingRules = new();
        ...
        public override bool StartUp(Vector3Int position, ITilemap tilemap, GameObject instantiatedGameObject) {
            if (instantiatedGameObject != null) {
                ...
                Vector3 gameObjectTranslation = new();
                Quaternion gameObjectRotation = new();
                Vector3 gameObjectScale = new();
        ...
        private static bool IsTilemapUsedTilesChange(Tilemap tilemap) {
            ...
            HashSet<TileBase> oldUsedTiles = m_CacheTilemapsNeighborPositions[tilemap].Key;
        ...
        private static void CachingTilemapNeighborPositions(Tilemap tilemap) {
            ...
            HashSet<TileBase> usedTiles = new();
            HashSet<Vector3Int> neighborPositions = new();
        ...
        public class TilingRule : TilingRuleOutput {
            ...
            public BoundsInt GetBounds() {
                BoundsInt bounds = new(Vector3Int.zero, Vector3Int.one);
