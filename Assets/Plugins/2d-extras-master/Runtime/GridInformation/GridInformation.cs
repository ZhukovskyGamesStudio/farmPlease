...
namespace UnityEngine.Tilemaps {
    ...
    public class GridInformation : MonoBehaviour, ISerializationCallbackReceiver {
        [SerializeField]
        [HideInInspector]
        private List<GridInformationKey> m_PositionIntKeys = new();

        [SerializeField]
        [HideInInspector]
        private List<int> m_PositionIntValues = new();

        [SerializeField]
        [HideInInspector]
        private List<GridInformationKey> m_PositionStringKeys = new();

        [SerializeField]
        [HideInInspector]
        private List<string> m_PositionStringValues = new();

        [SerializeField]
        [HideInInspector]
        private List<GridInformationKey> m_PositionFloatKeys = new();

        [SerializeField]
        [HideInInspector]
        private List<float> m_PositionFloatValues = new();

        [SerializeField]
        [HideInInspector]
        private List<GridInformationKey> m_PositionDoubleKeys = new();

        [SerializeField]
        [HideInInspector]
        private List<double> m_PositionDoubleValues = new();

        [SerializeField]
        [HideInInspector]
        private List<GridInformationKey> m_PositionObjectKeys = new();

        [SerializeField]
        [HideInInspector]
        private List<Object> m_PositionObjectValues = new();

        [SerializeField]
        [HideInInspector]
        private List<GridInformationKey> m_PositionColorKeys = new();

        [SerializeField]
        [HideInInspector]
        private List<Color> m_PositionColorValues = new();
        ...
        void ISerializationCallbackReceiver.OnBeforeSerialize() {
            ...
            foreach (KeyValuePair<GridInformationKey, GridInformationValue> kvp in PositionProperties)
