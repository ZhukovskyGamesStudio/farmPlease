...
namespace UnityEditor.Tilemaps {
    ...
    public class GameObjectBrush : GridBrushBase {
        ...
        [SerializeField]
        [HideInInspector]
        internal HiddenGridLayout hiddenGridLayout = new();
        ...
        public override void Paint(GridLayout gridLayout, GameObject brushTarget, Vector3Int position) {
            ...
            BoundsInt bounds = new(min, m_Size);
        ...
        private void PaintCell(GridLayout grid, Vector3Int position, Transform parent, BrushCell cell) {
            ...
            GameObject existingGO = GetObjectInCell(grid, parent, position);
            if (existingGO == null)
        ...
        public override void Rotate(RotationDirection direction, GridLayout.CellLayout layout) {
            ...
            BoundsInt oldBounds = new(Vector3Int.zero, oldSize);
        ...
        public override void Pick(GridLayout gridLayout, GameObject brushTarget, BoundsInt position, Vector3Int pivot) {
            ...
            foreach (Vector3Int pos in position.allPositionsWithin) {
                Vector3Int brushPosition = new(pos.x - position.x, pos.y - position.y, 0);
        ...
        private void FlipX() {
            BrushCell[] oldCells = m_Cells.Clone() as BrushCell[];
            BoundsInt oldBounds = new(Vector3Int.zero, m_Size);
        ...
        private static GameObject GetObjectInCell(GridLayout grid, Transform parent, Vector3Int position) {
            ...
            for (int i = 0; i < childCount; i++) {
                Transform child = parent != null ? parent.GetChild(i) : scene.GetRootGameObjects()[i].transform;
        ...
        private void SizeUpdated() {
            ...
            BoundsInt bounds = new(Vector3Int.zero, m_Size);
            foreach (Vector3Int pos in bounds.allPositionsWithin) m_Cells[GetCellIndex(pos)] = new BrushCell();
        }
        ...
        private static void SetSceneCell(GridLayout grid, Transform parent, Vector3Int position, GameObject go,
            ...
            if (PrefabUtility.IsPartOfPrefabAsset(go)) {
                ...
                foreach (Renderer renderer in instance.GetComponentsInChildren<Renderer>()) renderer.enabled = true;
            }
        ...
        public override int GetHashCode() {
            int hash = 0;
            unchecked {
                foreach (BrushCell cell in cells) hash = hash * 33 + cell.GetHashCode();
            }
