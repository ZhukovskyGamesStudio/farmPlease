...
namespace UnityEditor {
    ...
    public class HexagonalRuleTileEditor : RuleTileEditor {
        ...
        public override BoundsInt GetRuleGUIBounds(BoundsInt bounds, RuleTile.TilingRule rule) {
            foreach (KeyValuePair<Vector3Int, int> n in rule.GetNeighbors())
        ...
        public override void RuleMatrixOnGUI(RuleTile tile, Rect rect, BoundsInt bounds,
            ...
            for (int y = bounds.yMin; y < bounds.yMax; y++) {
                ...
                for (int x = bounds.xMin; x < xMax; x++) {
                    ...
                    Vector2 offset = new(x - bounds.xMin, -y + bounds.yMax - 1);
                    Rect r = flatTop
        ...
        protected override void CreatePreview() {
            ...
            foreach (Tilemap tilemap in m_PreviewTilemaps) {
