...
namespace UnityEditor {
    ...
    public class RuleTileEditor : Editor {
        ...
        protected virtual void OnDrawElement(Rect rect, int index, bool isactive, bool isfocused) {
            ...
            Rect spriteRect = new(rect.xMax - k_DefaultElementHeight - 5f, yPos, k_DefaultElementHeight,
        ...
        public void OnDrawHeader(Rect rect) {
            ...
            Rect toggleLabelRect = new(rect.x, rect.y, rect.width - toggleRect.width - 5f, rect.height);
        ...
        public virtual void RuleMatrixOnGUI(RuleTile tile, Rect rect, BoundsInt bounds,
        ...
        protected virtual void CreatePreview() {
            ...
            GameObject previewInstance = new();
            ...
            for (int i = 0; i < 4; i++) {
                GameObject previewTilemapGo = new();
