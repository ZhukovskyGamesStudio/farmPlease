...
#pragma warning restore CS0649
        ...
        protected virtual void Update() {
            if ((mode & OperatingMode.Queue) != OperatingMode.Queue) return;
        ...
        protected void OnApplicationFocus(bool hasFocus) {
            ...
            List<PendingNotification> notificationsToSave = new List<PendingNotification>(PendingNotifications.Count);
            foreach (PendingNotification pendingNotification in PendingNotifications)
        ...
        public void Initialize(params GameNotificationChannel[] channels) {
            ...
            foreach (GameNotificationChannel notificationChannel in channels) {
                ...
                AndroidNotificationChannel androidChannel = new AndroidNotificationChannel(notificationChannel.Id,
        ...
        public PendingNotification ScheduleNotification(IGameNotification notification) {
            ...
            PendingNotification result = new PendingNotification(notification);
