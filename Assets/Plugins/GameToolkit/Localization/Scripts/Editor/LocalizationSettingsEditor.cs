    ...
    public class LocalizationSettingsEditor : UnityEditor.Editor {
        ...
        private void OnEnable() {
            ...
            if (m_AvailableLanguages != null) {
                ...
                m_AvailableLanguagesList.drawElementCallback =
                ...
                m_AvailableLanguagesList.onCanRemoveCallback = (ReorderableList list) => { return list.count > 1; };
                m_AvailableLanguagesList.onAddDropdownCallback = (Rect buttonRect, ReorderableList list) => {
                    ...
                    menu.AddItem(new GUIContent("Add used languages", "Adds by searching used languages in assets."),
                        false, () => {
                            AddUsedLocales();
                            serializedObject.ApplyModifiedProperties();
                        });
            ...
            if (m_AvailableLanguagesList != null) {
                ...
                if (!m_GoogleAuthenticationFile.objectReferenceValue) {
                    EditorGUILayout.HelpBox(
                        "If you want to use Google Translate in editor or in-game, attach the service account or API key file claimed from Google Cloud.",
                        MessageType.Info);
                }
