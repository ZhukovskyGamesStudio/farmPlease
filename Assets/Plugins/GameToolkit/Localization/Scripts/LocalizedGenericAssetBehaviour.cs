...
namespace GameToolkit.Localization {
    ...
    public class LocalizedGenericAssetBehaviour<TLocalizedAsset, T> : LocalizedGenericAssetBehaviourBase
...
#if UNITY_EDITOR
            if (!Application.isPlaying) InitializePropertyIfNeeded();
#endif

            if (m_LocalizedAsset && m_PropertyInfo != null) {
#if UNITY_EDITOR
                if (!Application.isPlaying) Undo.RecordObject(m_Component, "Locale value change");
#endif
        ...
        public override List<PropertyInfo> FindProperties(Component component) {
            ...
            PropertyInfo[] allProperties = component.GetType().GetProperties();
