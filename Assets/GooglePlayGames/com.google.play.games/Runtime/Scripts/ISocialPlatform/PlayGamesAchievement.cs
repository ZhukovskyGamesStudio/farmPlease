...
namespace GooglePlayGames {
    ...
    internal class PlayGamesAchievement : IAchievement, IAchievementDescription {
        ...
        private readonly string mRevealedImageUrl = string.Empty;
        private readonly string mUnlockedImageUrl = string.Empty;
#if UNITY_2017_1_OR_NEWER
        ...
        private readonly ulong mPoints;
        ...
        public DateTime lastReportedDate { get; } = new(1970, 1, 1, 0, 0, 0, 0);
